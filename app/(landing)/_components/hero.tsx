  ...
  return (
    <section className="flex flex-col items-center gap-4 p-4">
      ...
      <h1 className="group font-cal text-5xl font-bold duration-1000 ease-out animate-in fade-in-0 slide-in-from-top-1/4 sm:text-6xl md:text-7xl lg:text-8xl">
        ...
        <span
          className="block text-center text-background duration-150 [text-shadow:_2px_6px_0_#000] group-hover:[text-shadow:_4px_8px_0_#000] sm:inline-flex"
